...
<div class="block">
  Чтобы заказать оборудывание, заполните форму ниже и укажите свой выбор в сообщении.
  <form>
    <div>
      <input type="text" id="name" placeholder="Ваше имя" onclick="$(this).css ('border-color', '#ccc')">
      <br> 
      <input type="phone" id="phone" placeholder="Номер телефона" onclick="$(this).css ('border-color', '#ccc')">
       <br> 
